  ...
  <button
    ...
    className={`flex items-center justify-center text-sm transition-all duration-300 cursor-pointer shadow-md active:translate-y-1 ${
      IconButton
        ...
        : 'py-2 px-4 rounded-full bg-orange-400 text-white border border-orange-400'
    } hover:bg-transparent hover:text-orange-400 ${
      disabled ? 'opacity-50 cursor-not-allowed hover:bg-orange-400 hover:text-white' : ''
    }`}
  >
  ...
  <button
    ...
    className={`flex items-center justify-center text-sm transition-all duration-300 cursor-pointer shadow-md active:translate-y-1 ${
      IconButton
        ...
        : 'py-2 px-4 rounded-full border border-orange-400 text-orange-400 bg-transparent'
    } hover:bg-orange-400 hover:text-white ${
      disabled ? 'opacity-50 cursor-not-allowed hover:bg-transparent hover:text-orange-400' : ''
    }`}
  >
    {buttonValue && <span>{buttonValue}</span>}
    {iconValue && <span className="ml-2">{iconValue}</span>}
