        ...
        <div className="flex flex-col gap-4">
          ...
          </p>
          {
            selectGender && (
              ...
              <select id="gender" value={gender} onChange={handleGenderChange} className="p-2 border bg-transparent rounded">
          ...
          <p className="w-full">
            <strong>Date Joined:</strong>{formData.dateJoined
                  ? new Date(formData.dateJoined).toLocaleString()
                  : 'Date not available'}
          </p>
          <p className="w-full">
