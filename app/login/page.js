  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200 || response.status === 201) {
        ...
        setTimeout(() => router.push('/usr'), 500);
  
        console.log('Token:', token);
        console.log('Full Name:', formData.fullName); // Use this to confirm formData is updated
        console.log('Email:', formData.email); // Use this to confirm formData is updated
